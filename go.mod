...
require (
	...
	github.com/hanson/collection v0.0.0-20230405030455-9abd7ead151a
...
require (
	...
	github.com/hertz-contrib/logger/accesslog v0.0.0-20230320032231-b153fe729ee7 // indirect
